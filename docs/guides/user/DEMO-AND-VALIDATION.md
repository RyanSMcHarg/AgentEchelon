...
#    --only=seed         run one phase. Valid ids:
#                        knowledge knowledge-rag seed user battle image-gen feedback
#                        experiments tasks profiles welcome evaluate admin
