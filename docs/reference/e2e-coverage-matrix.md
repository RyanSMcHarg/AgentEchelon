...
| [Demo Company Spec: Stratum Technologies](../specs/applications/SPEC-DEMO-COMPANY.md) | Implemented (the demo dataset and seed script s… | `e2e/classification-context.spec.ts`<br>`e2e/welcome.spec.ts` | 10 |
| [DESIGN: Battle Mode (`/battle`) - Technical Design](../specs/capabilities/DESIGN-BATTLE.md) | Implemented (premium-gated) | `e2e/battle.spec.ts` | 17 |
| [DESIGN: Experiments and Battle - Objective, Briefing, Lifecycle…](../specs/capabilities/DESIGN-EXPERIMENTS-BATTLE-DECISION-LOOP.md) | Implemented. The §4.3 drill-down's real-data re… | `e2e/experiments.spec.ts`<br>`e2e/battle.spec.ts` | 30 |
...
| [SPEC: Battle Mode (`/battle`) - Product Specification](../specs/capabilities/SPEC-BATTLE.md) | Implemented (premium-gated) | `e2e/battle.spec.ts` | 17 |
| [SPEC: Drift Detection](../specs/capabilities/SPEC-DRIFT-CONVERGENCE.md) | Partial. | `e2e/drift-detection.spec.ts` | 9 |
...
| [SPEC: Capability profiles and deployment-defined classifications](../specs/interaction/assistant-config/SPEC-CAPABILITY-PROFILES.md) | Implemented. Classifications and assistant prof… | `e2e/classification-context.spec.ts`<br>`e2e/profile-config.spec.ts`<br>`e2e/agent-intents.spec.ts` | 20 |
...
| [Conversation Configuration - a conversation is a configurable e…](../specs/interaction/conversation-config/SPEC-CONVERSATION-TYPES.md) | Partial (the `classification` type seam and the… | `e2e/classification-context.spec.ts` | 7 |
...
| [SPEC: Context sources and stores, and what restricts each one](../specs/interaction/conversation/SPEC-CONTEXT-SOURCES-AND-STORES.md) | Partial. Every path below marked "as built" is… | `e2e/classification-context.spec.ts` | 7 |
...
| [DESIGN: Admin-Action IAM Enforcement](../specs/interaction/identity-access/admin/DESIGN-ADMIN-ACTION-IAM-ENFORCEMENT.md) | Built, flag-gated (opt-in), deployed and valida… | `e2e/admin-attachments.spec.ts`<br>`e2e/credential-exchange.spec.ts` | 4 |
...
| [Access control by example: blocked interactions, the policy tha…](../specs/interaction/identity-access/core/ACCESS-CONTROL-BY-EXAMPLE.md) | Implemented (reference: worked examples of the… | `e2e/classification-context.spec.ts`<br>`e2e/credential-exchange.spec.ts` | 10 |
| [Identity & Access Model](../specs/interaction/identity-access/core/IDENTITY-AND-ACCESS-MODEL.md) | Implemented (reference: the live identity and a… | `e2e/credential-exchange.spec.ts`<br>`e2e/signin.spec.ts`<br>`e2e/classification-context.spec.ts` | 18 |
...
| [Conversation Security, Membership, and Information Isolation](../specs/interaction/identity-access/core/SPEC-CONVERSATION-SECURITY.md) | Implemented (Layers 1-6 are live; Layer 7 mixed… | `e2e/classification-context.spec.ts`<br>`e2e/mentions.spec.ts`<br>`e2e/credential-exchange.spec.ts` | 14 |
...
| [DESIGN: Chat Application](../specs/interface/chat/DESIGN-CHAT-APP.md) | Implemented | `e2e/signin.spec.ts`<br>`e2e/signup.spec.ts`<br>`e2e/agent-intents.spec.ts`<br>`e2e/mentions.spec.ts` | 29 |
| [SPEC: Chat Application](../specs/interface/chat/SPEC-CHAT-APP.md) | Implemented | `e2e/signin.spec.ts`<br>`e2e/signup.spec.ts`<br>`e2e/agent-intents.spec.ts`<br>`e2e/mentions.spec.ts`<br>`e2e/welcome.spec.ts` | 32 |
