...
└─ lib/stacks/
   ...
   ├─ basic-classification-stack.ts      class BasicClassificationStack     ← thin wrapper: supplies the profile's
   ├─ standard-classification-stack.ts   class StandardClassificationStack     ProfileTopology; team-owned.
   └─ premium-classification-stack.ts    class PremiumClassificationStack
```
