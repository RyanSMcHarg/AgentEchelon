...
- `docs/specs/interaction/assistant-config/SPEC-CONFIGURABLE-INTENT-PACK.md` - the per-deployment intent taxonomy that is already an append-ordered domain (the intent codebook).
