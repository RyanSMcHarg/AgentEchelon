...
const FlaggedResponsesTab: React.FC<FlaggedResponsesTabProps> = ({ data, isLoading, onReview, onOpenConversation }) => {
        ...
        <div className="admin-review-panel">
          <div className="admin-conversation-header">
            ...
            {expanded.channel_arn && onOpenConversation && (
              <button
                className="admin-inline-btn"
                onClick={() => onOpenConversation(String(expanded.channel_arn))}
              >
                Open conversation ↗
              </button>
            )}
            ...
            <div className="admin-review-actions">
              ...
              <div className="admin-review-buttons">
                <button
                  ...
                  onClick={() => {
                    onReview(String(expanded.exchange_id), 'approved', reviewNotes);
                    setExpandedId(null);
                    setReviewNotes('');
                  }}
                >
                ...
                <button
                  ...
                  onClick={() => {
                    onReview(String(expanded.exchange_id), 'rejected', reviewNotes);
                    setExpandedId(null);
                    setReviewNotes('');
                  }}
                >
